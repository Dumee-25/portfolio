...
method: 'A hybrid SEIR compartmental model coupled with machine-learning components for short-horizon forecasting and spatial risk mapping.'
open_questions:
  - 'How far ahead can the hybrid model forecast before mechanistic and learned components disagree?'
  - 'How well do parameters fit in one district transfer to districts with different climate and reporting practices?'
  - 'What is the right way to communicate forecast uncertainty so it is useful, not alarmist, to public-health users?'
receipts: []
last_verified: 2026-06-28
---

A hybrid epidemiological pipeline: a mechanistic SEIR backbone for outbreak
